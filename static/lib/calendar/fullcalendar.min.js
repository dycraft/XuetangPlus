...
!function(t) {
    ...
    function Ot(n, i) {
        ...
        function f(t) {
            if (u())
                return t && p(), lt++, K.updateSize(!0), lt--, !0
        }
        function g() {
            u() && p()
        }
        ...
        function Y(t) {
            ...
            if (1 === n) {
                ...
                if ("defaultDate" === e)
                    return;
                if ("businessHours" === e)
                    return void (K && (K.unrenderBusinessHours(), K.renderBusinessHours()));
                if ("timezone" === e)
                    return j.rezoneArrayEventSources(), void y()
            }
            l(), ot = {}, h()
        }
        function W(t, e) {
    ...
    function Yt() {
        ...
        function r(t, e) {
            var n,
                i;
            for ("reset" === e ? j = [] : "add" !== e && (j = w(j, t)), n = 0; n < t.length; n++)
                i = t[n], "pending" !== i._status && W++, i._fetchId = (i._fetchId || 0) + 1, i._status = "pending";
            for (n = 0; n < t.length; n++)
                i = t[n], s(i, i._fetchId)
        }
        function s(e, n) {
            a(e, function(i) {
                var r,
        ...
        function a(e, n) {
            ...
            for (i = 0; i < s.length; i++) {
                if (r = s[i].call(F, e, O.clone(), V.clone(), F.options.timezone, n), r === !0)
                    return;
                if ("object" == typeof r)
                    return void a(r, n)
            }
            var o = e.events;
            if (o)
                t.isFunction(o) ? (F.pushLoading(), o.call(F, O.clone(), V.clone(), F.options.timezone, function(t) {
                    n(t), F.popLoading()
                })) : t.isArray(o) ? n(o) : n();
            else {
                var l = e.url;
        ...
        function C(t, e) {
            ...
            if (s) {
                for (n = L(s), i = 0; i < n.length; i++)
                    r = n[i], r.source || (e && (_.events.push(r), r.source = _), j.push(r));
                return P(j), n
            }
            return []
        }
        function H(e) {
            ...
            for (null == e ? e = function() {
                ...
                return t._id == n
            }), j = t.grep(j, e, !0), i = 0; i < Y.length; i++)
    ...
    jt.queryMostGranularFormatUnit = function(t) {
        ...
        for (e = 0; e < s.length; e++)
            n = s[e], n.token && (i = oe[n.token.charAt(0)], i && (!r || i.value > r.value) && (r = i));
    ...
    var ve = jt.DayTableMixin = {
            ...
            sliceRangeByRow: function(t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    n = e * o, i = n + o - 1, r = Math.max(a, n), s = Math.min(u, i), r = Math.ceil(r), s = Math.floor(s), r <= s && d.push({
                        row: e,
            ...
            sliceRangeByDay: function(t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    for (n = e * l, i = n + l - 1, r = n; r <= i; r++)
                        s = Math.max(u, r), o = Math.min(d, r), s = Math.ceil(s), o = Math.floor(o), s <= o && c.push({
                            row: e,
    ...
    me.mixin({
        ...
        renderSegRow: function(e, n) {
            function i(e) {
                for (; o < e;)
                    d = (m[r - 1] || [])[o], d ? d.attr("rowspan", parseInt(d.attr("rowspan") || 1, 10) + 1) : (d = t("<td/>"), l.append(d)), v[r][o] = d, m[r][o] = d, o++
            }
            var r,
                s,
                o,
        ...
        limitRow: function(e, n) {
            function i(i) {
                for (; D < i;)
                    u = S.getCellSegs(e, D, n), u.length && (h = s[n - 1][D], y = S.renderMoreLink(e, D, u), m = t("<div/>").append(y), h.append(m), E.push(m[0])), D++
            }
            var r,
                s,
                o,
    ...
    var ye = jt.TimeGrid = pe.extend(ve, {
        ...
        computeLabelInterval: function(t) {
            ...
            for (n = Ne.length - 1; n >= 0; n--)
                if (i = e.duration(Ne[n]), r = _(i, t), ot(r) && r > 1)
                    return i;
            return e.duration(t)
        },
        computeEventTimeFormat: function() {
        ...
        Ee = jt.Calendar = wt.extend({
            ...
            buildViewSpec: function(t) {
                for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], d = [], c = t; c;)
                    i = Ut[c], r = l[c], c = null, "function" == typeof i && (i = {
                        class: i
    ...
    Ee.prototype.getCurrentBusinessHourEvents = function(t) {
        ...
        for (r = 0; r < n.length; r++)
            s = n[r], i && !s.dow || (s = t.extend({}, Re, s), e && (s.start = null, s.end = null), l.push.apply(l, this.expandEvent(this.buildEventFromInput(s), o.start, o.end)));
        return l
    };
